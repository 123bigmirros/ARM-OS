...
void Uart_Init(void)
{
	...
	IOMUXC_SW_MUX_CTL_PAD_UART1_TX_DATA = (volatile unsigned int *)(0x800E0084);
	IOMUXC_SW_MUX_CTL_PAD_UART1_RX_DATA = (volatile unsigned int *)(0x800E0088);
	IOMUXC_UART1_RX_DATA_SELECT_INPUT = (volatile unsigned int *)(0x800E0624);
